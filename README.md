...
This Project consisted of dual `RTL8211F-CG` chips and is used to explore and demonstrate FPGA Ethernet application. This Project is compatible with [CUBE](https://github.com/AnterCreeper/CUBE) FPGA Devkit.  
